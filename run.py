...
class KeyPointClassifier(object):
    def __init__(self, model_path='model/keypoint.tflite', num_threads=2):
...
def main():
    ...
    with open('model/keypoint_label.csv',
...
def mode_text(image, mode):
    if mode == 1:
        cv.putText(image, "Training mode", (10, 90), cv.FONT_HERSHEY_SIMPLEX, 0.6, (255, 255, 255), 1, cv.LINE_AA)
